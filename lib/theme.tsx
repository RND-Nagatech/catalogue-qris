...
const darkColors: typeof lightColors = {
  ...
  outline: "#889390",
  outlineStrong: "#BEC9C6",
  outlineVariant: "#3E4947",
  divider: "#26364B",
  shadow: "#000000",
  scrim: "rgba(0, 0, 0, 0.64)",
  primary: "#85D5C9",
  primaryContainer: "#00685F",
  primaryText: "#00201D",
  onPrimary: "#00201D",
  onPrimaryContainer: "#D7FFF6",
  inversePrimary: "#00685F",
  primaryFixed: "#A1F1E5",
  primaryFixedDim: "#85D5C9",
  buttonPrimary: "#00685F",
  secondary: "#C0C1FF",
  ...
  onSecondaryContainer: "#FFFBFF",
  tertiary: "#FCBA66",
  tertiaryContainer: "#825100",
  tertiaryFixedDim: "#FCBA66",
  onTertiary: "#452B00",
  onTertiaryContainer: "#FFFBFF",
  danger: "#FFB4AB",
  error: "#FFB4AB",
  ...
  success: "#85D5C9",
  successContainer: "#123F3A",
  warning: "#FCBA66",
  warningContainer: "#4F2D00",
  info: "#85D5C9",
  infoContainer: "#102034",
  bottomNavBackground: "#0B1C30",
  bottomNavActive: "#85D5C9",
  bottomNavInactive: "#BEC9C6",
  tabInactive: "#BEC9C6",
  buttonSecondary: "#102034",
